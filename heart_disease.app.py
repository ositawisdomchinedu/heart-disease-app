...
with open('heart_disease_prediction.joblib', 'rb') as file:
...
st.image("C:/Users/Hp/Desktop/new_projects/heart.jpeg", width=300)

# Sidebar for user inputs
st.sidebar.header("Patient Data")
st.sidebar.image("C:/Users/Hp/Desktop/new_projects/heart.jpeg", width=300)
